...
@section('title','LIMOESOEKA || PRODUCT PAGE')
                                ...
                                <div class="price-filter-inner">
                                    {{-- <div id="slider-range" data-min="10" data-max="2000" data-currency="%"></div>
												...
												<div class="label-input">
													<span>Range:</span>
													<input type="text" id="amount" name="price_range" value='@if(!empty($_GET['price'])) {{$_GET['price']}}
                                    @endif' placeholder="Add Your Price"/>
                                </div>
                            </div> --}}
                            @php
                        ...
                        <div class="shop-shorter">
                            ...
                            <div class="single-shorter">
                                ...
                                <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                    ...
                                    <option value="category" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='category'
                                        ) selected @endif>Category</option>
                                    <option value="brand" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='brand' )
